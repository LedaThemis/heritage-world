...
export const SITE_ERA_MAP: Record<string, string[]> = {
    "Al-Tahira Church Collection": ["ottoman", "modern"],
    "Al-Hadba Minaret": ["islamic"],
    "Erbil Citadel": ["assyrian", "islamic", "ottoman", "modern"],
    "Iraqi Museum Gate": ["assyrian", "babylonian", "modern"],
    "Ancient City of Uruk": ["sumerian"],
    "Al-Chibayish Marshlands": ["sumerian", "modern"],
    "Al-Ukhaidir Fortress": ["islamic"],
    "Mosul City Walls": ["islamic", "ottoman"],
    "Hatra Temple": ["assyrian"],
    "Lion of Babylon": ["babylonian"],
    "Great Mosque of Samarra and Malwiya Minaret": ["islamic"],
    "Ana Minaret": ["islamic"],
    "Ziggurat of Ur": ["sumerian"],
    "Taq Kasra (Arch of Ctesiphon)": ["babylonian"],
};
